    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light p-0">
            <div class="container-fluid col-12">
                ...
                <div class="w-md-75 d-flex justify-content-center col-6">
                    <Search />
                </div>
                <div class="d-flex justify-content-end align-items-center col-3" id="navbarNav">
                    <div v-if="isLoggedIn && isUser" class="point-support d-none d-lg-flex" @click="toggleShowModal">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="icon-support h-100">
                            <path
